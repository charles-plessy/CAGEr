...
described above in section \@ref(input-formats).  First we have provide
information about input files, sample names, etc. in a `DataFrame` object.
...
```{r ConsensusClustersExpressionProfiles, echo=FALSE, fig.align="center", fig.cap="Expression clusters"}
